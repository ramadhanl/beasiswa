          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-lg-12">
              <table class="display">
                <thead>
                  <tr>
                    <th style="background-color:#367FAA;border:0px;border-right:5px;border-style:solid;border-color:black;"><a href="<?php echo base_url(); ?>pegawai/proses_seleksi_ppa">Beasiswa PPA</a></th>
                    <th style="border:0px;"><a href="<?php echo base_url(); ?>pegawai/proses_seleksi_bpp">Beasiswa BPP</a></th>
                  </tr>
                </thead>
              </table>
              <table class="display" style="margin-bottom:0px;">
                <thead>
                  <tr>
                    <th style="background-color:#ECF0F5;color:black;">Proses Seleksi Beasiswa PPA</th>
                  </tr>
                </thead>
              </table>
              <table class="display">
