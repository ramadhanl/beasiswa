          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-lg-12">
              <table class="display" style="border:0px;background-color:#DD4B39;">
                <thead>
                  <tr>
                    ...
                    <th style="border:0px;background-color:#DD4B39;"><a href="<?php echo base_url(); ?>pegawai/proses_seleksi_bpp">Beasiswa BPP</a></th>
                  </tr>
                </thead>
              </table>
              <table class="display" style="margin-top:30px;margin-bottom:20px;border:0px;">
                <thead>
                  <tr>
                    <th style="background-color:#ECF0F5;color:black;border:0px;">Proses Seleksi Beasiswa PPA</th>
                  </tr>
                </thead>
              </table>
              ...
              <?php
                ...
                <tbody>
                <?php
                $query = $this->db->get('form_beasiswa_ppa');
                foreach ($query->result() as $row) {
                  echo "<tr class='";
                  if($row->id_form%2==0)
                    echo "even'>";
              ...
              <?php
              if($count!=0)
                echo '<a href="'.base_url().'pegawai/hitung_skor_ppa" class="btn btn-primary col-sm-12" style="background-color:#DD4B39;margin-top:20px;border:0px;">Proses Data</a>';
              ?>
            </div>
          </div><!-- /.row (main row) -->
        </section><!-- /.content -->
