        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-lg-12">
              <table class="display">
                <thead>
                  <tr>
                    ...
                    <th style="background-color:#575398;border:0px;"><a href="<?php echo base_url(); ?>admin/parameter_bpp">Beasiswa BPP</a></th>
                  </tr>
                </thead>
              </table>
              ...
              <a id="submit-btn" class="btn btn-primary col-sm-12" style="background-color:#605CA8;margin-top:20px;" href="<?php echo base_url(); ?>admin/parameter_bpp_ubah"> Ubah Data</a>
            </div>
          </div><!-- /.row (main row) -->
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
