          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-lg-12">
              <table class="display">
                <thead>
                  <tr>
                    <th style="background-color:#DD4B39;border:0px;border-right:5px;border-style:solid;border-color:black;"><a href="<?php echo base_url(); ?>admin/parameter_ppa">Beasiswa PPA</a></th>
              ...
              <table class="display" style="margin-bottom:0px;">
                <thead>
                  <tr>
                    <th style="background-color:#ECF0F5;color:black;">Nilai Parameter Beasiswa BPP</th>
                  </tr>
                </thead>
              </table>
              <table class="display">
              ...
              <a id="submit-btn" class="btn btn-primary col-sm-12" style="background-color:#DD4B39;margin-top:20px;" href="<?php echo base_url(); ?>admin/parameter_bpp_ubah"> Ubah Data</a>
            </div>
          </div><!-- /.row (main row) -->
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
