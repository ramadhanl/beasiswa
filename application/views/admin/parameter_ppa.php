<div class="col-md-12" style="background:none;">
	<div class="col-md-6" style="background:none;">
		<a href="<?php echo  base_url();?>admin/parameter_ppa"><h4 class="tipe" style="float:right;background-color:#B9B9B9;color:white;">Beasiswa PPA</h4></a>
	</div>
	<div class="col-md-6" style="background:none;">
		<a href="<?php echo  base_url();?>admin/parameter_bpp"><h4 class="tipe" style="float:left;">Beasiswa BPP</h4></a>
	</div>
</div>
<br><br><br><br><br>
<div class="col-md-12" style="background:none;text-align:center;">
	<h3>Nilai Parameter Beasiswa PPA</h3><br><br>
	...
	<a id="submit-btn" class="btn col-sm-12" style="color:white;background-color:#B9B9B9;margin-top:20px;" href="<?php echo base_url(); ?>admin/set_parameter_ppa"> Ubah Data</a>
</div>