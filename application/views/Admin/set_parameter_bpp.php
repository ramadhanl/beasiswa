<div class="col-md-12" style="background:none;">
	<div class="col-md-6" style="background:none;">
		<a href="<?php echo  base_url();?>admin/set_parameter_ppa"><h4 class="tipe" style="float:right;">Beasiswa PPA</h4></a>
	</div>
	<div class="col-md-6" style="background:none;">
		<a href="<?php echo  base_url();?>admin/set_parameter_bpp"><h4 class="tipe" style="float:left;background-color:#B9B9B9;color:white;">Beasiswa BPP</h4></a>
	</div>
</div>
<br><br><br><br><br>
<div class="col-md-12" style="background:none;text-align:center;">
	<h3>Set Nilai Parameter Beasiswa BPP</h3><br><br>
	<table class="table" style="text-align:center;">
		...
		<tbody>
		<form action="<?php echo base_url(); ?>admin/simpan_parameter/bpp" method="POST">
